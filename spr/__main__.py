...
async def help_command(_, message: Message):
    ...
    kb = ikb(
        {
            "Help💡": "bot_commands",
            "How To Use?🎁": "https://t.me/AbhinaveSuresh/16",
            "Add Me To Your Group🔰": f"https://t.me/{BOT_USERNAME}?startgroup=new",
            "Support Chat👽": "https://t.me/vazhasupport",
        }
    )
    mention = message.from_user.mention
    await message.reply_photo(
        "https://telegra.ph/file/49ee9587f4231d2c7298e.jpg",
        caption=f"Hi {mention}🙋, I'm Anti Porn Bot🔞,"
...
async def help_parser(name, keyboard=None):
    ...
    return (
        f"Hello {name}, I'm Anti Porn Bot🔞, I can protect "
...
async def help_button(client, query: CallbackQuery):
    ...
    top_text = (
        f"Hello {u}, I'm Anti Porn Bot🔞, I can protect "
        + "your group from Spam and NSFW media using "
        + "machine learning. Choose an option from below."
    )
    if mod_match:
